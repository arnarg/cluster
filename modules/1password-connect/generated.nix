...
in
{
  ...
  options = {
    resources = {
      "onepassword.com"."v1"."OnePasswordItem" = mkOption {
        ...
        type = (
          types.attrsOf (
            submoduleForDefinition "onepassword.com.v1.OnePasswordItem" "onepassworditems" "OnePasswordItem"
              "onepassword.com"
              "v1"
          )
        );
  ...
  config = {
    ...
    resources = {
      "onepassword.com"."v1"."OnePasswordItem" = mkAliasDefinitions options.resources."onePasswordItems";
