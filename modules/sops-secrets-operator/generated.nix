    ...
    "isindir.github.com.v1alpha3.SopsSecretSops" = {
      options = {
        ...
        "azure_kv" = mkOption {
          ...
          type = types.nullOr (coerceAttrsOfSubmodulesToListByKey "isindir.github.com.v1alpha3.SopsSecretSopsAzure_kv" "name" []);
          apply = attrsToList;
        };
        ...
        "gcp_kms" = mkOption {
          ...
          type = types.nullOr (types.listOf (submoduleOf "isindir.github.com.v1alpha3.SopsSecretSopsGcp_kms"));
        };
        "hc_vault" = mkOption {
          description = "Hashicorp Vault KMS configurarion";
          type = types.nullOr (types.listOf (submoduleOf "isindir.github.com.v1alpha3.SopsSecretSopsHc_vault"));
        };
        "kms" = mkOption {
    ...
    "isindir.github.com.v1alpha3.SopsSecretSpec" = {
      options = {
        "secretTemplates" = mkOption {
          ...
          type = coerceAttrsOfSubmodulesToListByKey "isindir.github.com.v1alpha3.SopsSecretSpecSecretTemplates" "name" [];
          apply = attrsToList;
        };
        "suspend" = mkOption {
